...
<script type="text/javascript">
	...
	function openAddBlogTypeDialog(){
		...
		url='${pageContext.request.contextPath}/cc/blogType/save.do';
	}
	...
	function openModifyBlogDialog(){
		...
		$('#fm').form('load',row);
		url='${pageContext.request.contextPath}/cc/blogType/save.do?id='+row.id;
	}
	...
	function deleteBlogType(){
		...
		$.messager.confirm('系统提示','您确定要删除这<font color="red">'+SelectedRows.length+'</font>条数据么数据!',function(r){
			if(r){
				$.post('${pageContext.request.contextPath}/cc/blogType/delete.do', {ids:ids}, function(result) {
					if(result.success){
						if(result.exist){
...
<table id="dg" title="博客管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/cc/blogType/list.do" fit="true" toolbar="#tb">
	<thead>
		<tr>
