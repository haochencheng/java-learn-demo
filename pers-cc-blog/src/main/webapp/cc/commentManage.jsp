...
<script type="text/javascript">
	...
	function deleteComment(){
		...
		$.messager.confirm('系统提示','您确定要删除这<font color="red">'+SelectedRows.length+'</font>条评论!',function(r){
			if(r){
				$.post('${pageContext.request.contextPath}/cc/comment/delete.do', {ids:ids}, function(result) {
					if(result.success){
...
<table id="dg" title="评论审核管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/cc/comment/list.do" fit="true" toolbar="#tb">
	<thead>
		<tr>
