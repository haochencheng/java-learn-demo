...
<div id="p" class="easyui-panel" title="修改个人信息" fit="true">
	<form id="form1" action="${pageContext.request.contextPath}/cc/blogger/save.do" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    ue.addListener('ready',function(){
    	//通过ajax请求数据
    	UE.ajax.request('${pageContext.request.contextPath}/cc/blogger/find.do', 
    		{
    			method:'post',
    			async:false,
    			data:{},
