...
<script type="text/javascript">
	...
	function openPasswordModifyDialog(){
		...
		url='${pageContext.request.contextPath}/cc/blogger/modifyPassword.do';
	}
	...
	function refreshSystem(){
		$.post('${pageContext.request.contextPath}/cc/system/refreshSystem.do', function(result) {
			if(result.success){
	...
	function logout(){
		$.messager.confirm('系统提示','您确定要退出系统么？',function(r){
			if(r){
				window.location.href="${pageContext.request.contextPath}/cc/blogger/logout.do";
			}
		});
	}
</script>
