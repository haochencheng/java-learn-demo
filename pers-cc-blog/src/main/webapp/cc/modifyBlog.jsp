...
<script type="text/javascript">
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/cc/blog/save.do",{'title':title,'id':'${param.id}','blogType.id':blogTypeId,
...
<script type="text/javascript">
    ...
    ue.addListener('ready',function(){
    	//通过ajax请求数据
    	UE.ajax.request('${pageContext.request.contextPath}/cc/blog/findById.do', 
    		{
    			method:'post',
    			async:false,
    			data:{'id':'${param.id}'},
