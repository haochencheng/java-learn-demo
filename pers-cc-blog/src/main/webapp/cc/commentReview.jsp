...
<script type="text/javascript">
	...
	function commentReview(state){
		...
		$.messager.confirm('系统提示','您确定要审核这<font color="red">'+SelectedRows.length+'</font>条评论么!',function(r){
			if(r){
				$.post('${pageContext.request.contextPath}/cc/comment/review.do', {ids:ids,state:state}, function(result) {
					if(result.success){
...
<table id="dg" title="评论审核管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/cc/comment/list.do?state=0" fit="true" toolbar="#tb">
	<thead>
		<tr>
