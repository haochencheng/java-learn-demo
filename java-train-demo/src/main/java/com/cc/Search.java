...
public class Search {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="3ec2cc33c2ad8a1d357e8cf7ade19bbf";

    //1.站到站查询（含票价）
    public static void getRequest1(Map<String, String> params){
        String result =null;
        String url ="http://apis.juhe.cn/train/s2swithprice";//请求接口地址
       /* Map<String, String> params = new HashMap<String, String>();//请求参数
*/            params.put("start","武汉");//出发站
        params.put("end","成都");//终点站
